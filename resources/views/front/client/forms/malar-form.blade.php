        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <p class="banner__txt">Vergleichen Sie innerhalb kürzester Zeit bis zu 6 Angebote von erfahrenen
                    Umzugsunternehmen. </p>
                <img class="banner__mobile-img" src="/images/offerten-hummer-maler.webp" alt="">
                <div class="d-flex mt-3">
                    <a class="btn" href="#section-steps">ANFRAGE STARTEN</a>
                </div>
            </div>
            <div class="col-lg-5">
                <img class="banner__desktop-img" src="/images/offerten-hummer-maler.webp" alt="">
            </div>
        </div>
    </div>
</section>
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-maler-banner1.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-maler-banner2.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-maler-banner3.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
