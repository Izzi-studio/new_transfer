        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <p class="banner__txt">Vergleichen Sie innerhalb kürzester Zeit bis zu 6 Angebote von erfahrenen
                    Umzugsunternehmen. </p>
                <img class="banner__mobile-img" src="/images/offerten-hummer-elektriker.webp" alt="">
                <div class="d-flex mt-3">
                    <a class="btn" href="#section-steps">ANFRAGE STARTEN</a>
                </div>
            </div>
            <div class="col-lg-5">
                <img class="banner__desktop-img" src="/images/offerten-hummer-elektriker.webp" alt="">
            </div>
        </div>
    </div>
</section>
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-elektriker-banner1.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-elektriker-banner2.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section class="banner-txt marginTop100">
    <div class="container banner-txt__container" style="background-image: url(/images/offerten-hummer-elektriker-banner3.webp)">
        <div class="row justify-content-center">
            <div class="col-lg-8">
...
<section id="section-steps" class="steps-form paddingTop60">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h2 class="section-title text-start">Elektriker kostenlos anfragen</h2>
                <p class="mt-3">Beschreiben Sie Ihr Projekt und wir vermitteln Ihnen bis zu drei Elektriker für eine unverbindliche Beratung und Offertstellung</p>
            </div>
        </div>
