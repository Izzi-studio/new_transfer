...
class PaymentControllerIdealPay extends Controller
{
    ...
    public function index(Request $request){
		...
		if($amount){
			...
			$payrexx = new \Payrexx\Payrexx('offertenhammer', 'Kvtvb3mH9C164kk61VzFU7f7Yu5ZP3','', 'ideal-pay.ch');
			...
			$gateway->setSuccessRedirectUrl(route('api.partner.data'));
		...
		return redirect()->to(route('partner.cabinet','personliche-daten/info'));
